...
/**
 * データベース接続テスト用ユーティリティクラス
 * Render PostgreSQL接続問題の診断に使用
 */
public class DatabaseConnectionChecker {
    ...
    private static void testBasicConnection() {
        System.out.println("\n1. 基本接続テスト");
        String url = "jdbc:postgresql://dpg-d12hm7je5dus7396aujg-a.singapore-postgres.render.com:5432/tb_info_kanri?sslmode=require";
    ...
    private static void testWithDifferentSSL() {
        System.out.println("\n2. SSL設定変更テスト");
        String baseUrl = "jdbc:postgresql://dpg-d12hm7je5dus7396aujg-a.singapore-postgres.render.com:5432/tb_info_kanri";
        String username = System.getenv("DB_USERNAME");
        String password = System.getenv("DB_PASSWORD");
        ...
        // SSL必須（証明書検証なし）
        testConnection(baseUrl + "?sslmode=require&sslcert=&sslkey=&sslrootcert=", username, password, "SSL必須（証明書検証なし）");
    }
    ...
    private static void testWithTimeout() {
        System.out.println("\n3. タイムアウト設定テスト");
        String url = "jdbc:postgresql://dpg-d12hm7je5dus7396aujg-a.singapore-postgres.render.com:5432/tb_info_kanri?sslmode=require&connectTimeout=60&socketTimeout=60";
        String username = System.getenv("DB_USERNAME");
        String password = System.getenv("DB_PASSWORD");
     ...
     * 実際の接続テストを実行
     */
    private static void testConnection(String url, String username, String password, String testName) {
        System.out.println("\n--- " + testName + " ---");
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection(url, props)) {
                ...
                System.out.println("接続情報: " + conn.getMetaData().getDatabaseProductName() + 
